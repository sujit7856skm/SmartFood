...
<div class="row">
	<div class="col-sm-12">
		<h3 class="text-success pt-3" style="text-align:center; font-family:Monotype Corsiva;">welcome <%=session.getAttribute("admin_name") %></h3>
	</div>
</div>
<hr class="m-0">
<div class="row m-2 pb-3">
	<div class="col-sm-2 p-3 ml-2  mr-5" id="admin_menu" style="background-color:white; border-radius:10px;">
	    <ul style="list-style:circle" class="m-0 pl-3">
	    	<li class="m-1"><a href="admin_add_category.jsp">Add Category</a></li>
	    	<li class="m-1"><a href="admin_view_category.jsp">View all Category</a></li>
	    	<li class="m-1"><a href="admin_allow_item.jsp">Allow Items</a></li>
	    	<li class="m-1"><a href="admin_view_vendor.jsp">View all Vendors</a></li>
	    	<li class="m-1"><a href="admin_aprove_vendor.jsp">Vendor registration request</a></li>
	    	<li class="m-1"><a href="admin_all_items.jsp">View all Item</a></li>
	    </ul>   
    </div>
    <!-- -------------------Admin menu start here----------------- -->
