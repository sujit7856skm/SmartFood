 	...
 	<%
		...
		String city = (String) session.getAttribute("city");
 		try
 		{
 			...
 			ResultSet rs=stmt.executeQuery("select sf_item.item_category, sf_item.item_name,sf_item.item_price,sf_item.item_imgurl,sf_item.item_id from sf_item left join sf_vendor on sf_item.vendor_email=sf_vendor.vendor_email where sf_vendor.vendor_state='"+state+"'and sf_vendor.vendor_city='"+city+"' and item_category='breakfast' and item_status='true'");
 			while(rs.next())
 			{
 				%>
 				<a href="#">
